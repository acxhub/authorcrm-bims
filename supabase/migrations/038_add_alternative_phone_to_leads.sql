-- Add a third phone number to leads (e.g. work line, agent, family contact)
ALTER TABLE leads ADD COLUMN IF NOT EXISTS alternative_phone_number varchar(20);

-- Include alternative_phone_number in the lead-list global search RPC
