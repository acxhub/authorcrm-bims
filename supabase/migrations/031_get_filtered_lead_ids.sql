-- Server-side lead filtering via RPC (avoids URL length limits with large ID sets)
-- Uses NOT EXISTS subqueries for efficient untouched/no_tags filtering
